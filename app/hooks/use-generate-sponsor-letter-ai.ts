...
const baseUrl = "/internal-api/generate-sponsor-letter-ai";
...
export const useGenerateSponsorLetterAi = () => {
  const {
    mutateAsync: onGenerateSponsorLetterAi,
    isPending: onGenerateSponsorLetterAiLoading,
  } = useMutation({
    ...
    onError: (error: unknown) => {
      console.error(
        "[generate-sponsor-letter-ai] error:",
  ...
  return {
    ...
    onGenerateSponsorLetterAiLoading,
  };
};
