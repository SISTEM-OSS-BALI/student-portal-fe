...
import { SidebarMainAdmission } from "@/app/data/admission/main/sidebar-data";
import { SidebarSettingAdmission } from "@/app/data/admission/setting/sidebar-data";
...
export const SiderAdmission = () => {
  ...
  const mainItems = useMemo(() => SidebarMainAdmission(), []);
  const settingItems = useMemo(() => SidebarSettingAdmission(), []);
